...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function()
			return game:HttpGet('https://raw.githubusercontent.com/Trarivis/SkidForRoblox/'..readfile('skid/profiles/commit.txt')..'/'..select(1, path:gsub('skid/', '')), true)
		end)
...
general:CreateButton({
	...
	mainapi.Save = function() end
		...
		if shared.VapeDeveloper then
			...
			loadstring(game:HttpGet('https://raw.githubusercontent.com/skidvape/SkidForRoblox/'..readfile('skid/profiles/commit.txt')..'/loader.lua', true))()
		end
	end,
