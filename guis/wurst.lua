...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/skidvape/SkidForRoblox/'..readfile('skid/profiles/commit.txt')..'/'..select(1, path:gsub('skid/', '')), true) end)
